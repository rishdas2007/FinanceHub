...
export const BOLLINGER_TOOLTIP = "Bollinger Bands %B position. Fixed signal direction: High %B (>0.8) now properly identified as bearish (overbought) signal. Signal thresholds adjusted from ±0.25 to ±0.6 for appropriate sensitivity.";
